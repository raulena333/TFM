...
def simulateBatchParticlesWorker(args):
    ...
    energyVoxel0 = np.sum(localEnergyDeposited[:,:, 0], axis=(0, 1))
    energyVoxel1 = np.sum(localEnergyDeposited[:,:, 1], axis=(0, 1))
    energyVoxel2 = np.sum(localEnergyDeposited[:,:, 2], axis=(0, 1))
